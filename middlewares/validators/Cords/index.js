...
/**
 * @description Validate that the body is provided and that it is valid
 * @param req {object} Express MW
 * @param res {object} Express MW
 * @param next {function} Express MW
 */
function bodyIsPresent( req, res, next ) {
    ...
    if(body && typeof body === "object" && Object.keys( req.body ).length > 0) {
        next();
    } else {
...
/**
 * @description Validate that the user is present and valid
 * @param req {object} Express MW
 * @param res {object} Express MW
 * @param next {function} Express MW
 */
...
/**
 * @description Validate that the file is present and valid
 * @param req {object} Express MW
 * @param res {object} Express MW
 * @param next {function} Express MW
 */
